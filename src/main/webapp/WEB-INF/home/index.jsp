...
<meta
	description="Meschola � la piattaforma digitale per la didattica che consente a docenti e studenti di interpretare fatti, argomenti e personaggi in modo originale e collaborativo, sfruttando i meccanismi comunicativi e relazionali tipici dei social network.">
...
<link rel="stylesheet"
	href="/assets/public/js/vendor/angular-ui-bootstrap-bower/ui-bootstrap-csp.css">
<link rel="stylesheet"
	href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/ui-lightness/jquery-ui.min.css">
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/ng-dialog/0.5.1/css/ngDialog.min.css">
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/ng-tags-input/3.0.0/ng-tags-input.min.css">
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/angular-bootstrap-lightbox/0.9.0/angular-bootstrap-lightbox.min.css">
<link rel="stylesheet"
...
<link rel="stylesheet/less"
	href="/assets/public/css/custom-newspaper.less">
...
<link rel="stylesheet/less"
	href="/assets/public/css/less/media-queries.less">
<link rel="stylesheet/less"
	href="/assets/public/css/less/article-two-columns.less">
<link rel="stylesheet/less"
	href="/assets/public/css/less/article-one-column-img.less">
<link rel="stylesheet/less"
	href="/assets/public/css/less/article-two-columns-img.less">
<link rel="stylesheet/less"
	href="/assets/public/css/less/article-column-image.less">
<link rel="stylesheet/less"
	href="/assets/public/css/less/article-one-column.less">
...
<body data-ng-cloak>
	...
	<script
		src="/assets/public/js/vendor/jquery-ui/ui/i18n/datepicker-it.js"></script>
	<script
	...
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/angular-ui-date/0.0.8/date.min.js"></script>
	...
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/danialfarid-angular-file-upload/7.3.8/ng-file-upload.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/danialfarid-angular-file-upload/7.3.8/ng-file-upload-shim.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/ng-dialog/0.5.1/js/ngDialog.min.js"></script>
	<script
		src="/assets/public/js/vendor/angular-native-dragdrop/draganddrop.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/ngInfiniteScroll/1.0.0/ng-infinite-scroll.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/ng-tags-input/3.0.0/ng-tags-input.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/angular-bootstrap-lightbox/0.9.0/angular-bootstrap-lightbox.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-switch/3.3.2/js/bootstrap-switch.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.7.2/js/bootstrap-select.min.js"></script>
	<script
	...
	<script
		src="/assets/public/js/vendor/angular-fullscreen/angular-fullscreen.js"></script>
	<script src="/assets/public/js/support/angular-p5.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/0.4.9/p5.min.js"
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="/assets/public/js/vendor/scrollReveal.js/dist/scrollReveal.min.js"
		type="text/javascript"></script>
	<script
