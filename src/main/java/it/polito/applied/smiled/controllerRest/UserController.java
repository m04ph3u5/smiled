...
public class UserController extends BaseController{
	...
	public List<Message> getMyMessagesWithYou(@PathVariable String userId, @AuthenticationPrincipal CustomUserDetails activeUser, 
		...
		//Non controllo che userId sia nella mia lista di relazioni perchï¿½ potrei averlo avuto in passato e vorrei quindi poter accedere ai messaggi tra me e quell'utente
	...
	/*TODO valutare sicurezza su questo metodo e necessitÃ  del metodo stesso
